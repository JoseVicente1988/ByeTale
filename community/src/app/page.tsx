  ...
  return (
    <main>
      ...
      <section className="hero" id="inicio" aria-labelledby="hero-title">
        ...
        <div className="shell heroLayout">
          <div className="heroCopy">
            ...
            <div className="actions">
              ...
              <a className="button secondary" href="#participa">
                Cómo participar
              </a>
            </div>
            ...
            <div className="tech" aria-label="Tecnologías y pilares del proyecto">
              ...
              <span>ENet</span>
              <span>Player Sync</span>
              <span>Encrypted Networking</span>
            </div>
          </div>
        ...
        <a className="scrollCue" href="#mundo" aria-label="Continuar hacia la sección del mundo">
          ...
          <article className="streamBand">
            <div className="streamIdentity">
              ...
              <div>
                ...
                <strong>El stream formará parte del flujo de desarrollo.</strong>
              </div>
            </div>
            <p>
              Cuando conectemos tu canal, cada directo podrá enlazar con propuestas,
              tareas, votaciones o castings que estén activos en la comunidad.
            </p>
            <span className="streamStatus">Canal pendiente</span>
          </article>
        </div>
      </section>

      <section className="section worldSection" id="mundo">
        <div className="shell">
          <div className="sectionHead">
            <div>
              <span>El mundo</span>
              <h2>ByeTale ya tiene un ADN propio.</h2>
            </div>
            <p>
              El repositorio contiene infraestructura multijugador, recursos de personajes
              y Godspire Citadel. La comunidad web crece alrededor de lo que el juego ya es,
              no alrededor de una plantilla genérica.
            </p>
          </div>
          ...
          <div className="worldGrid">
            <article className="featureCard featureLarge">
              ...
              <div>
                <span className="label gold">Localización</span>
                <h3>Godspire Citadel</h3>
                <p>
                  Uno de los entornos 3D existentes del proyecto y una referencia central
                  para la dirección fantasy de ByeTale.
                </p>
              </div>
            </article>
            ...
            <article className="featureCard">
              ...
              <div>
                <span className="label">Criaturas</span>
                <h3>Personajes y enemigos</h3>
                <p>Player Character, Skeleton y Slime ya forman parte de los recursos del juego.</p>
              </div>
            </article>
            ...
            <article className="featureCard">
              ...
              <div>
                ...
                <h3>Multijugador primero</h3>
                <p>
                  Login, persistencia, spawning, ENet y sincronización son parte del núcleo
                  técnico sobre el que seguirá creciendo el proyecto.
                </p>
              </div>
            </article>
          </div>
        ...
        <div className="shell">
          <div className="sectionHead">
            <div>
              ...
              <h2>Roadmap de ByeTale</h2>
            </div>
            <p>
              El objetivo es que esta vista lea siempre el estado oficial desde Neon.
              El roadmap será una ventana al desarrollo, no una copia desconectada del foro.
            </p>
          </div>
      ...
      <section className="section participationSection" id="participa">
        <div className="shell">
          <div className="sectionHead">
            <div>
              <span>Comunidad</span>
              <h2>Tu aportación puede dejar huella.</h2>
            </div>
            <p>
              Los votos muestran interés y ayudan a priorizar conversaciones. La dirección
              final del juego seguirá perteneciendo a ByeTale.
            </p>
          </div>
          ...
          <div className="participation">
            {participation.map((item) => (
              <article className="participationCard" key={item.title}>
                ...
                <h3>{item.title}</h3>
                <p>{item.copy}</p>
                <a href="#inicio">Próximamente <span aria-hidden="true">→</span></a>
              </article>
            ))}
          </div>
        </div>
        ...
        <div className="shell">
          <article className="manifesto">
            <div>
              ...
              <p>
                Transparencia sobre qué se está construyendo, por qué se toman decisiones
                y qué aportaciones de la comunidad terminan formando parte del juego.
              </p>
            </div>
            <a className="button primary" href="#inicio">Volver arriba</a>
          </article>
        </div>
      </section>
      ...
      <footer>
        <div className="shell footer">
          <div className="brand">
            <Image
              className="brandIcon footerIcon"
              src="/byetale-icon.svg"
              alt=""
              width={38}
              height={38}
          ...
          <p>Godot · ENet · comunidad · roadmap · testing · voces</p>

          <a
            href="https://github.com/JoseVicente1988/ByeTale"
            target="_blank"
            rel="noreferrer"
          >
